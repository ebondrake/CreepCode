var roleRepairer = {
  ...
  run: function(creep) {
    ...
    if(creep.memory.repairing){
      ...
      var spawnToRepair = creep.pos.findClosestByRange(FIND_STRUCTURES, {filter: function(object){return object.structureType === STRUCTURE_SPAWN && (object.hits > object.hitsMax / 3);}});
